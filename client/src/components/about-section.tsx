          ...
          {features.map((feature, index) => {
            ...
            return (
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-tid-black/10 dark:bg-tid-black/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <IconComponent className="text-tid-black w-8 h-8" />
                </div>
