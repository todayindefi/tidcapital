            ...
            <div className="rounded-xl shadow-lg bg-white dark:bg-gray-900 p-8">
              <div className="text-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-tid-red/10 dark:bg-tid-red/20 rounded-lg">
                    <div className="text-2xl font-bold text-tid-red">4</div>
                    <div className="text-sm text-gray-600 dark:text-gray-300">Risk Dimensions</div>
                  </div>
                  <div className="p-4 bg-tid-red/10 dark:bg-tid-red/20 rounded-lg">
                    <div className="text-2xl font-bold text-tid-red">10</div>
          ...
          <div className="space-y-8">
            {riskCategories.map((category, index) => (
              <div key={index} className="flex items-start space-x-4">
                <div className="w-8 h-8 bg-tid-red rounded-full flex items-center justify-center flex-shrink-0 mt-1">
