        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8">
          ...
          <div className="text-center mt-6">
            ...
            <a 
              ...
              className="inline-flex items-center text-tid-blue hover:text-tid-blue-dark dark:text-tid-blue dark:hover:text-tid-blue-dark font-semibold transition-colors"
            >
